...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://or3ki404:Oreki404@or3ki404.s9527pk.mongodb.net/?retryWrites=true&w=majority&appName=or3ki404"
...
module.exports = {
  ...
  packname:  process.env.PACK_NAME || 'MADE BY ᴏʀᴇᴋɪ',
  
  botname:   process.env.BOT_NAME === undefined ? "ᴏʀᴇᴋɪ_404" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'oreki' : process.env.OWNER_NAME,  
  ...
  LANG: process.env.THEME|| 'orekisama',
